...
export const styles = css`
  ...
  ai-chat .chat-icon {
    ...
    background: linear-gradient(
      135deg,
      var(--sn-cat-data, #a78bfa),
      var(--sn-node-selected, #4a9eff)
    );
  ...
  ai-chat .chat-bubble[data-role='user'] {
    ...
    background: linear-gradient(
      135deg,
      color-mix(in srgb, var(--sn-node-selected, #4a9eff) 20%, transparent),
      color-mix(in srgb, var(--sn-cat-data, #a78bfa) 20%, transparent)
    );
