...
export let THEME_ELEMENT_GROUPS = [
  ...
  },
  {
    ...
    tokens: ['--sn-success-color', '--sn-success-bg', '--sn-success-border', '--sn-warning-color', '--sn-danger-color', '--sn-danger-bg', '--sn-danger-border', '--sn-badge-bg', '--sn-badge-border', '--sn-badge-color', '--sn-banner-bg', '--sn-banner-border', '--sn-banner-color', '--sn-empty-state-color', '--sn-loading-bar-bg', '--sn-effect-loading-pulse'],
