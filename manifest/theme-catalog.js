...
const CSS_TOKEN_CLASSIFIERS = [
  ...
  { kind: 'component-alias', group: 'status', pattern: /^--sn-(badge|empty-state)-/ },
...
export let THEME_ELEMENT_GROUPS = [
  ...
  },
  {
    ...
    tokens: ['--sn-success-color', '--sn-warning-color', '--sn-danger-color', '--sn-badge-bg', '--sn-badge-border', '--sn-badge-color', '--sn-empty-state-color', '--sn-loading-bar-bg', '--sn-effect-loading-pulse'],
...
export let THEME_RULE_BLOCKS = [
  ...
  },
  {
    ...
    appliesTo: ['panel-layout', 'sn-card', 'sn-button', 'sn-field', 'sn-badge', 'sn-empty-state', 'sn-tree-view', 'sn-tree-panel', 'chat-composer', 'chat-transcript', 'project-tabs', 'source-viewer', 'source-editor', 'sn-list-item', 'sn-loading-overlay'],
