...
const CSS_TOKEN_CLASSIFIERS = [
  ...
  { kind: 'semantic-alias', group: 'surface', pattern: /^--sn-(bg|panel-bg|surface|border|node-bg|node-border|node-selected|node-accent|node-hover|node-header-bg|node-radius|node-shadow|text|text-dim|bg-overlay|shadow-color)$/ },
...
export let THEME_ELEMENT_GROUPS = [
  {
    ...
    tokens: ['--sn-panel-bg', '--sn-surface', '--sn-border', '--sn-card-bg', '--sn-card-border', '--sn-card-radius', '--sn-card-padding', '--sn-node-border', '--sn-node-shadow', '--sn-node-radius'],
  ...
  },
  {
    ...
    tokens: ['--sn-node-bg', '--sn-node-border', '--sn-node-selected', '--sn-conn-color', '--sn-cat-server', '--sn-cat-control', '--sn-cat-data', '--sn-subgraph-accent'],
...
export let THEME_RULE_BLOCKS = [
  ...
  },
  {
    ...
    appliesTo: ['panel-layout', 'sn-card', 'sn-button', 'sn-field', 'sn-badge', 'sn-banner', 'sn-empty-state', 'sn-tree-view', 'sn-tree-panel', 'chat-composer', 'chat-transcript', 'project-tabs', 'source-viewer', 'source-editor', 'sn-list-item', 'sn-list-detail-shell', 'sn-loading-overlay'],
...
export let THEME_TOKENS = {
  'default-dark': {
    ...
    component: {
      ...
      layoutPreviewJoinBackground: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-danger-color) 30%, transparent)' },
      layoutPreviewJoinBorder: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-danger-color) 60%, transparent)' },
      layoutPreviewLine: { $type: 'color', $value: 'var(--sn-node-selected)' },
      layoutPreviewLineShadow: { $type: 'shadow', $value: '0 0 8px var(--sn-layout-preview-line)' },
      ...
      successBackground: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-success-color) 18%, transparent)' },
      successBorder: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-success-color) 32%, transparent)' },
      successBackgroundHover: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-success-color) 28%, transparent)' },
      successBorderHover: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-success-color) 52%, transparent)' },
      dangerBackground: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-danger-color) 18%, transparent)' },
      dangerBorder: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-danger-color) 32%, transparent)' },
      subgraphBackground: { $type: 'gradient', $value: 'linear-gradient(135deg, color-mix(in srgb, var(--sn-subgraph-accent) 12%, transparent) 0%, color-mix(in srgb, var(--sn-subgraph-accent) 8%, transparent) 100%)' },
      subgraphBackgroundHover: { $type: 'gradient', $value: 'linear-gradient(135deg, color-mix(in srgb, var(--sn-subgraph-accent) 22%, transparent) 0%, color-mix(in srgb, var(--sn-subgraph-accent) 15%, transparent) 100%)' },
      subgraphBorder: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-subgraph-accent) 30%, transparent)' },
      subgraphBorderHover: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-subgraph-accent) 50%, transparent)' },
      fieldControlSubtleBorder: { $type: 'color', $value: 'hsl(var(--sn-hue-base) var(--sn-sat-muted) var(--sn-lit-text) / var(--sn-alpha-faint))' },
      fieldSelectIndicator: { $type: 'gradient', $value: 'linear-gradient(45deg, transparent 50%, var(--sn-text-dim) 50%), linear-gradient(135deg, var(--sn-text-dim) 50%, transparent 50%)' },
      fieldToggleBackground: { $type: 'color', $value: 'hsl(var(--sn-hue-base) var(--sn-sat-muted) var(--sn-lit-text) / 0.1)' },
      fieldToggleThumbBackground: { $type: 'color', $value: 'var(--sn-text-dim)' },
      fieldToggleThumbActiveBackground: { $type: 'color', $value: 'var(--sn-text)' },
    ...
    alias: {
      ...
      listDetailBackground: { $type: 'color', $value: 'var(--sn-panel-bg)' },
      listDetailBorder: { $type: 'color', $value: 'var(--sn-node-border)' },
      listDetailRadius: { $type: 'dimension', $value: 'var(--sn-card-radius)' },
      listDetailSidebarWidth: { $type: 'dimension', $value: 'minmax(220px, 30%)' },
      listDetailSidebarBackground: { $type: 'color', $value: 'var(--sn-node-bg)' },
      listDetailMainBackground: { $type: 'color', $value: 'transparent' },
      listDetailHeaderBackground: { $type: 'color', $value: 'transparent' },
      listDetailHeaderPadding: { $type: 'dimension', $value: '10px 12px' },
      listDetailMainPadding: { $type: 'dimension', $value: '12px' },
      listDetailTitleSize: { $type: 'dimension', $value: '12px' },
      listDetailTitleColor: { $type: 'color', $value: 'var(--sn-text)' },
    ...
    provider: {
      rndPro: {
        color: { $type: 'color', $value: 'var(--sn-cat-data)' },
        background: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-provider-rnd-pro-color) 20%, transparent)' },
      },
      official: {
        color: { $type: 'color', $value: 'var(--sn-node-selected)' },
        background: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-provider-official-color) 20%, transparent)' },
      },
      google: {
        color: { $type: 'color', $value: 'var(--sn-success-color)' },
        background: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-provider-google-color) 20%, transparent)' },
      },
      community: {
        color: { $type: 'color', $value: 'var(--sn-warning-color)' },
        background: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-provider-community-color) 20%, transparent)' },
      },
      default: {
        color: { $type: 'color', $value: 'var(--sn-text-dim)' },
        background: { $type: 'color', $value: 'var(--sn-node-hover)' },
      },
    },
    syntax: {
      keyword: { $type: 'color', $value: 'hsl(var(--sn-hue-danger) var(--sn-sat-vivid) 82%)' },
      string: { $type: 'color', $value: 'hsl(var(--sn-hue-warning) var(--sn-sat-vivid) 65%)' },
      comment: { $type: 'color', $value: 'var(--sn-text-dim)' },
      function: { $type: 'color', $value: 'hsl(var(--sn-hue-accent) var(--sn-sat-vivid) 84%)' },
      number: { $type: 'color', $value: 'var(--sn-syntax-string)' },
      builtin: { $type: 'color', $value: 'var(--sn-syntax-function)' },
      property: { $type: 'color', $value: 'hsl(var(--sn-hue-data) var(--sn-sat-vivid) 78%)' },
      literal: { $type: 'color', $value: 'var(--sn-syntax-keyword)' },
      doc: { $type: 'color', $value: 'hsl(var(--sn-hue-success) 22% 56%)' },
      docTag: { $type: 'color', $value: 'hsl(var(--sn-hue-success) 50% 70%)' },
      docType: { $type: 'color', $value: 'hsl(var(--sn-hue-accent) 72% 72%)' },
      template: { $type: 'color', $value: 'hsl(var(--sn-hue-warning) 44% 64%)' },
      templateTag: { $type: 'color', $value: 'hsl(var(--sn-hue-accent) 48% 58%)' },
      templateAttr: { $type: 'color', $value: 'hsl(var(--sn-hue-accent) var(--sn-sat-vivid) 80%)' },
      templateBracket: { $type: 'color', $value: 'var(--sn-text-dim)' },
      templateInterpolation: { $type: 'color', $value: 'hsl(var(--sn-hue-warning) 50% 76%)' },
      templateSelector: { $type: 'color', $value: 'hsl(var(--sn-hue-warning) 56% 68%)' },
      templateProperty: { $type: 'color', $value: 'var(--sn-syntax-template-attr)' },
      templateValue: { $type: 'color', $value: 'var(--sn-syntax-template)' },
    },
    diagnostic: {
      errorBackground: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-danger-color) 7%, transparent)' },
      errorBorder: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-danger-color) 55%, transparent)' },
      warningBackground: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-warning-color) 5%, transparent)' },
      warningBorder: { $type: 'color', $value: 'color-mix(in srgb, var(--sn-warning-color) 45%, transparent)' },
    },
    radius: {
