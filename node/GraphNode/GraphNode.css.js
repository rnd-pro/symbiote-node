...
export let styles = css`
  graph-node {
    ...
    &[data-processing] {
      ...
      box-shadow:
        0 0 16px color-mix(in srgb, var(--sn-node-accent, #4a9eff) 40%, transparent),
    ...
    &[data-svg-shape] {
      ...
      & .sn-node-header {
        ...
        background: var(
          --sn-node-header-bg,
          color-mix(in srgb, var(--sn-node-accent, #4a9eff) 20%, var(--sn-node-bg, #16213e))
        );
  ...
  @keyframes sn-node-error-pulse {
    ...
    100% {
      box-shadow:
        0 0 16px color-mix(in srgb, var(--sn-danger-color, #ef4444) 35%, transparent),
        0 0 4px color-mix(in srgb, var(--sn-danger-color, #ef4444) 50%, transparent);
    }
    50% {
      box-shadow:
        0 0 24px color-mix(in srgb, var(--sn-danger-color, #ef4444) 50%, transparent),
        0 0 8px color-mix(in srgb, var(--sn-danger-color, #ef4444) 70%, transparent);
    }
  }
