...
`symbiote-node` is now a terminal migration package.

Use `symbiote-ui` for Web Components, provider manifests, themes, schemas, WebMCP metadata, and JSDA SSR integration.
